...
// Quando importar a logo não precisa escrever @ que qualifica as dimensões da imagem
// ImageBackground é uma View que aceita imagem, ela recebe um source onde vc indica a imagem
